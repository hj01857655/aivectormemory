...
INDEXES = [
    ...
    "CREATE INDEX IF NOT EXISTS idx_auth_login_limits_lock_until ON auth_login_limits(lock_until)",
    "CREATE INDEX IF NOT EXISTS idx_user_project_access_user ON user_project_access(username)",
]
...
USER_PROJECT_ACCESS_TABLE = """
CREATE TABLE IF NOT EXISTS user_project_access (
    username TEXT NOT NULL,
    project_dir TEXT NOT NULL,
    created_at TEXT NOT NULL,
    PRIMARY KEY (username, project_dir)
)"""
